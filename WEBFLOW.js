...
function preload() {
  deskImage = loadImage(
    "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/foto-espansa-bn.webp"
  );
  ...
  objects = [
    ...
    },
    {
      ...
      y: 785,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/vinileBN.png"
      ),
      hoveredImage: loadImage(
    ...
    },
    {
      ...
      y: 2225,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/occhialiBN.png"
      ),
      hoveredImage: loadImage(
    ...
    },
    {
      ...
      y: 2395,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/racchettaBN.png"
      ),
      hoveredImage: loadImage(
    ...
    },
    {
      ...
      y: 1433,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/pianolaBN.png"
      ),
      hoveredImage: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/pianola-hovered.png"
      ),
      sound: loadSound(
        "https://raw.githubusercontent.com/emmatroni/background-plastify/main/assets/pianola-beat.mp3"
      ),
    },
    {
      name: "calendario",
      ...
      y: 2449,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/calendarioBN.png"
      ),
      hoveredImage: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/calendario-hovered.png"
      ),
      sound: loadSound(
        "https://raw.githubusercontent.com/emmatroni/background-plastify/main/assets/calendario-beat.mp3"
      ),
    },
    {
      name: "spartito",
      ...
      sound: loadSound(
        "https://raw.githubusercontent.com/emmatroni/background-plastify/main/assets/spartito-beat.mp3"
      ),
    },
    {
      name: "passaporto",
      ...
      y: 579,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/passaportoBN.png"
      ),
      hoveredImage: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/passaporto-hovered.png"
      ),
      sound: loadSound(
        "https://raw.githubusercontent.com/emmatroni/background-plastify/main/assets/passaporto-beat.mp3"
      ),
    },
    {
      name: "liquore",
      ...
      y: 2240,
      image: loadImage(
        "https://cdn.jsdelivr.net/gh/emmatroni/background-plastify@main/assets/liquoreBN.png"
      ),
      hoveredImage: loadImage(
